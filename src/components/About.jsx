      ...
      <div className="px-[21%] max-lg:px-[10%] max-sm:px-[6%]">
        ...
        <div className="flex w-full gap-6 max-sm:flex-col">
          <div className="w-1/2 max-sm:w-full">
            <motion.h1
              className="font-semibold text-2xl mt-5 mb-3"
          ...
          <div className="w-1/2 text-justify max-sm:w-full">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <motion.div
                  className="border border-neutral rounded-full p-2 hover:bg-neutral hover:shadow-xl transition-all stroke-neutral hover:stroke-slate-100"
